...
.certifications ul li{
    ...
    @foreach ($sections as $section)
        ...
        <div class="section_area education" style="margin-top: 10px;">
        ...
        @elseif($section->name=='Certifications')
        ...
        @elseif($section->name=='Additional Information')
        <div class="section_area additional" style="margin-top: 10px;">
            <h3>@if($section->name_updated!=null){{$section->name_updated}}@else{{$section->name}}@endif</h3>            
            {!!$additional->description!!}
        </div>

        @elseif($section->name=='Professional Summary')
