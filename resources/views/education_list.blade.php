        ...
        <div class="card bcard">
            ...
            <table id="simple-table" class="mb-0 table table-borderless table-bordered-x brc-secondary-l3 text-dark-m2 radius-1 overflow-hidden">
                ...
                <tbody class="mt-1">
                  ...
                  <tr class="bgc-h-yellow-l4 d-style">                
                    ...
                    <td>
                      <a href="#" class="text-blue-d1 text-600 text-95">{{ $item->school_name }}</a>
                    </td>
                    ...
                    <td>
                      ...
                      <div class="d-none d-lg-flex">
                        <a href="/education-edit/{{$item->id}}" class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-success btn-a-lighter-success">
                          <i class="fa fa-pencil-alt"></i>
                        </a>

                        <a href="/educationDelete/{{$item->id}}" onclick="confirmDelete()"  class="mx-2px btn radius-1 border-2 btn-xs btn-brc-tp btn-light-secondary btn-h-lighter-danger btn-a-lighter-danger">
          ...
          <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
            <div class="offset-md-0 col-md-12 text-nowrap">                 
              ...
              <a href="/add-education" style="float: right"  class="btn btn-outline-lightgrey btn-bgc-white btn-bold ml-2 px-4">
                Add New Education
              </a>
