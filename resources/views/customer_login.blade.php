...
<html lang="en">
  ...
  <head>
    ...
    <title>Login -Resume Builder Admin</title>
                    ...
                    <div id="loginBgCarousel" class="carousel slide minw-100 h-100">
                      ...
                      <div class="carousel-inner minw-100 h-100">
                        <div class="carousel-item active minw-100 h-100">
                          ...
                          <div style="background-image: url({{asset('assets/assets/image/login-bg-1.svg')}});" class="px-3 bgc-blue-l4 d-flex flex-column align-items-center justify-content-center">
                            <a class="mt-5 mb-2" href="html/dashboard.html">
                              <i class="fa fa-leaf text-success-m2 fa-3x"></i>
                            </a>

                            <h2 class="text-primary-d1">
                             Resume Builder <span class="text-80 text-dark-l1">Application</span>
                            </h2>
                  ...
                  <div id="id-col-main" class="col-12 col-lg-7 py-lg-5 bgc-white px-0">
                    ...
                    <div class="tab-content tab-sliding border-0 p-0" data-swipe="right">
                      ...
                      <div class="tab-pane mh-100 px-3 px-lg-0 pb-3" id="id-tab-signup" data-swipe-prev="#id-tab-login">
                        ...
                        {{-- <form autocomplete="off" class="form-row mt-4"> --}}
                            {!! Form::open(['url'=>'save-customer','class'=>'form-row mt-4', 'id'=>'form_sample_1', 'method'=>'post' , 'enctype'=>'multipart/form-data'])!!}
                            ...
                            <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-1">
                                <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                                  <input type="text" class="form-control form-control-lg pr-4 shadow-none" id="id-signup-username" name="name" />
                                  <i class="fa fa-user text-grey-m2 ml-n4"></i>
                          ...
                          <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                            <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                              <input type="email" name="email" class="form-control form-control-lg pr-4 shadow-none" id="id-signup-email" />
                          ...
                          <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-1">
                            <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                              <input type="password" name="password" class="form-control form-control-lg pr-4 shadow-none" id="id-signup-password" />
                              <i class="fa fa-key text-grey-m2 ml-n4"></i>
