...
<html lang="en">
  ...
  <head>
    ...
    <title>Dashboard - Resume Builder App</title>
              ...
              <ul class="nav has-active-border active-on-right">
                ...
                <li class="nav-item active">
                  ...
                  <a href="/dashboard" class="nav-link">
                    <i class="nav-icon fa fa-fa-home"></i>
                  ...
                  <div class="hideable submenu collapse">
                    <ul class="submenu-inner">
                      ...
                      <li class="nav-item">
                        ...
                        <a href="select-template" class="nav-link">

                          <span class="nav-text">
               				  <span style="color: #fff">Create resume</span>
                          </span>
                      ...
                      <li class="nav-item">
                        ...
                        <a href="resume-list" class="nav-link">

                          <span class="nav-text">
                            <span style="color: #fff">Resume list</span>
                          </span>
            ...
            <div class="footer-inner bgc-white-tp1">              
              ...
              <div class="pt-3 border-none border-t-3 brc-grey-l2 border-double">              
                ...
                <span style="float: right; margin-right:10px;">
                  <a href="">How to Use</a> | <a href="">FAQ</a> | <a href="">Privacy</a> | <a href="">Terms &
                  Conditions</a>
                </span>
