...
<html lang="en">
  ...
  <head>
    ...
    <title>Login - MyResumeDash</title>
                      ...
                      <div class="carousel-inner minw-100 h-100">
                        <div class="carousel-item active minw-100 h-100">
                          ...
                          <div class="px-3 bgc-blue-l4 d-flex flex-column align-items-center justify-content-center">
                            <a class="mt-5 mb-2" href="http://myresumedash.com">
...
{{-- 
                            <h2 class="text-blue-l1">
                                MyResumeDash <span class="text-80 text-white-tp3"> App</span>
                            </h2> --}}
                          </div>
                        </div>
                        ...
                        <div class="carousel-item minw-100 h-100">
                          <div class="d-flex flex-column align-items-center justify-content-start">
                            <div class="bgc-black-tp4 radius-1 p-3 w-90 text-center my-3 h-100">
                              ...
                              {{-- <h2 class="text-blue-l1">
                               MyResumeDash <span class="text-80 text-white-tp3">Application</span>
                              </h2> --}}
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="carousel-item minw-100 h-100">
                          <div style="background-image: url({{asset('assets/assets/image/login-bg-4.jpg')}});" class="d-flex flex-column align-items-center justify-content-start">
                            ...
                            {{-- <h2 class="text-blue-d1">
                             MyResumeDash <span class="text-80 text-dark-tp3">Application</span>
                            </h2> --}}
                          </div>
                        </div>
                    ...
                    ?>
                      ...
                      <div class="tab-pane mh-100 px-3 px-lg-0 pb-3" id="id-tab-signup" data-swipe-prev="#id-tab-login">
                        ...
                        <div class="d-lg-none text-secondary-m1 my-4 text-center">
                          ...
                          <h1 class="text-170">
                            <span class="text-blue-d1">MyResumeDash, Inc <span class="text-80 text-dark-tp4">Application</span></span>
                          </h1>
                        ...
                        <form action="create-user" method="post" autocomplete="off" class="form-row mt-4">
                          @csrf
                            ...
                            <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-1">
                                <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                                  <input type="text" class="form-control form-control-lg pr-4 shadow-none" id="id-signup-username" required name="name" />
                                  <i class="fa fa-user text-grey-m2 ml-n4"></i>
                              ...
                              {{-- <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-1">
                                <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                                  ...
                                  <select class="form-control form-control-lg pr-4 shadow-none" name="profession">
                          ...
                          <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                            <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                              <input type="email" required name="email" class="form-control form-control-lg pr-4 shadow-none" id="id-signup-email" />
                          ...
                          <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-1">
                            <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
                              <input type="password" required name="password" class="form-control form-control-lg pr-4 shadow-none" id="id-signup-password" />
                              <i class="fa fa-key text-grey-m2 ml-n4"></i>
                          ...
                          <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-2">
                            <label class="d-inline-block mt-3 mb-0 text-secondary-d2">
                              <input type="checkbox" required class="mr-1" id="id-agree" />
                              <span class="text-dark-m3">I have read and agree to <a href="#" class="text-blue-d2">terms</a></span>
                            </label> 
                            
                           
                            <button type="submit" class="btn btn-success btn-block px-4 btn-bold mt-2 mb-3">
                              Sign Up
                            </button>
                          </div>
                        </form>
            ...
            <div class="d-lg-none my-3 text-white-tp1 text-center">
              <i class="fa fa-leaf text-success-l3 mr-1 text-110"></i> MyResumeDash, Inc&copy; 2020
            </div>
          </div>
        </div>
