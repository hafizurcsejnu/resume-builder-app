...
<div class="col-md-6">
<form>
<input type="text" name="resume_name" id="resume_name" placeholder="Resume name" value="@if($resume->status=="updated"){{$resume->name}}@endif" class="form-control" style="margin-top: 7px;">
