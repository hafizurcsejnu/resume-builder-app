            ...
            <div class="card-body section_detail h-98 d-flex flex-column1 justify-content-center py-2 py-md-3 px-0 px-md-4">
              <form action="educationStore" id="descForm" method="post"  class="mt-lg-3" autocomplete="off">
                ...
                <div class="row"> 
                  ...
                  <input type="text" list="schools" name="school_name" placeholder="University of California" required class="form-control form-control-lg shadow-none" id="id-form-field-2">
                  <datalist id="schools">
                      <?php 
                  ...
                  <!-- 
                    {{-- <select name="high_school" required="" class="select2_class" id="form-field-select-1" style="height: 46px;">                 
                      <option value="">&nbsp;</option>
                      <?php 
                  ...
                  <div class="col-md-2 input-floating-label1 text-blue-d2 brc-blue-m1">                    
                    ...
                    <input type="text"  id="city" placeholder="City" name="city" class="form-control form-control-lg shadow-none" id="id-form-field-2">                    
                  ...
                  <div class="col-md-2 input-floating-label1 text-blue-d2 brc-blue-m1">                    
                    ...
                    <input type="text" id="state" name="state" placeholder="State" class="form-control form-control-lg shadow-none" id="id-form-field-2">                    
                  </div>
                  ...
                  <div class="col-md-2 input-floating-label1 text-blue-d2 brc-blue-m1">                    
                    ...
                    <input type="text" id="country" placeholder="Country" name="country" class="form-control form-control-lg shadow-none" id="id-form-field-2">                    
                  </div>
                </div>
