  ...
  <div class="page-content container container-plus">
    <div class="page-header pb-2">
      <h1 class="page-title text-primary-d2 text-150">
        Almost done! Let’s finish with a strong summary
      </h1>
    </div>
    ...
    <div class="row mt-2 mt-lg-4 pt-2">
      ...
      <div class="col-12 col-lg-6">
        ...
        <div class="card border-0 shadow-sm">
          ...
          <form action="@if(isset($professional_summary)){{"updateProfessional"}}@else{{"storeProfessional"}}@endif" method="post" id="exp_form">
            @csrf

          <div class="card bcard border-1 brc-dark-l1">
            <div class="card-body p-0">             
                <textarea id="summernote" name="description" rows="25">
                  @if(isset($professional_summary)){{$professional_summary}}@endif
                </textarea>             
            </div>
            ...
            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
              <div class="offset-md-0 col-md-12 text-nowrap">                 
                ...
                <button id="@if(!isset($professional_summary)){{"submitBtn"}}@endif" class="btn btn-info btn-bold px-4" style="float: right"  type="submit">
