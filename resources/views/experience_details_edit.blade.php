      ...
      <div class="col-12 col-lg-6">
        <div class="card bcard h-100">
          ...
          <div class="card-header">              
              ...
              <?php 
              $collection = DB::table('data_experiences')->distinct('word')->get();
              $present = DB::table('data_experiences')->where('word_tense','present_word')->distinct('word')->get();
              $past = DB::table('data_experiences')->where('word_tense','past_word')->distinct('word')->get();
              $future = DB::table('data_experiences')->where('word_tense','future_word')->distinct('word')->get();
            ?>
            <datalist id="all">
                @foreach ($collection as $item)                  
          ...
          <div class="card-body  d-flex flex-column1 justify-content-center py-2 py-md-3 px-0 px-md-4">            
            <div class="task_area" id="task_area" style="width: 100%; height: 400px; overflow-y: scroll;">              
            </div> 
          </div>
