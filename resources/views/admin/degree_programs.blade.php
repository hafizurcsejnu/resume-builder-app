...
<div class="modal fade" id="addNewEntry" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="data_degree_program_store">
        @csrf
                    ...
                    @foreach($data as $item)                                  
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="align-middle">
                          ...
                          <span class="d-none d-lg-inline">
                              <a data-rel="tooltip" title="Delete" href="/data_degree_program_delete/{{$item->id}}" onclick="confirmDelete()" class="v-hover">
