...
<div class="modal fade" id="addNewEntry" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="data_skill_store">
        @csrf
                  ...
                  <table id="datatable" class="d-style w-100 table text-dark-m1 text-95 border-y-1 brc-black-tp11 collapsed">
                    ...
                    <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
                      <tr>
                        ...
                        <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">skill </th>                      
                    ...
                    @foreach($data as $item)                                  
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="text-grey"> {{$item->skills}} </td>
                        ...
                        <td class="align-middle">
                            ...
                            <div class="modal-dialog" role="document"  style="width:800px!important">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <form method="post" action="data_skill_update"   class="mt-lg-3" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="row"> 
                                      ...
                                      <div class="col-md-12">
                                        <span">
                                         ...
                                         <textarea name="skills" rows="10" class="form-control">
                                             {{ $item->skills }}
                                         </textarea>
                          ...
                          <span class="d-none d-lg-inline">
                              <a data-rel="tooltip" title="Delete" href="/data_skill_delete/{{$item->id}}" onclick="confirmDelete()" class="v-hover">
