...
<div class="modal fade" id="addNewEntry" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="data_award_college_store">
        @csrf
                    ...
                    @foreach($data as $item)                                  
                      <tr class="d-style bgc-h-default-l4">
                        ...
                        <td class="align-middle">
                            ...
                            <div class="modal-dialog" role="document"  style="width:800px!important">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <form method="post" action="data_award_college_update"   class="mt-lg-3" autocomplete="off">
                                    @csrf
                          ...
                          <span class="d-none d-lg-inline">
                              <a data-rel="tooltip" title="Delete" href="/data_award_college_delete/{{$item->id}}" onclick="confirmDelete()" class="v-hover">
